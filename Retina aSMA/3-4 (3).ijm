...
saveAs("Tiff", "H:/230500 Nimo round2_histology_brain/LectinaSMCA10X_enhance/_Step4_thres_crop_OR/"+title+".tif");

imageCalculator("AND create", "lectin-"+title+".tif","aSMCA-"+title+".tif");
selectWindow("Result of lectin-"+title+".tif");
saveAs("Tiff", "H:/230500 Nimo round2_histology_brain/LectinaSMCA10X_enhance/_Step4_thres_crop_AND/"+title+".tif");
run("Close All");
